...
{   
    public static void imprimirSalario(Funcionario x){
        System.out.println("Seu salário contando com o bônus é R$" + x.calcularSalario());
    }
	...
	public static void main(String[] args) {
        ...
        imprimirSalario(gerenteComercial);
        Programador programadorJava = new Programador("Vinicius", 8000, "Java");
        programadorJava.setLinguagem("Python");
        imprimirSalario(programadorJava);
	}
}
